...
public class EnrolledContract {
    ...
    public EnrolledContract Sync(JSONObject jsonObject) throws JSONException {
        ...
        this.sno = jsonObject.getString(EnrollTable.COLUMN_NAME_SNO);
    ...
    public EnrolledContract Hydrate(Cursor cursor) {
        ...
        this.sno = cursor.getString(cursor.getColumnIndex(EnrollTable.COLUMN_NAME_SNO));
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(EnrollTable.COLUMN_NAME_SNO, this.sno);
